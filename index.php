...
<form id="map-form">
	<label for="start">Address 1: </label>
  <input type="text" placeholder="Address 1" id="address1" /><br>
  <label for="start">Address 2: </label>
  <input type="text" placeholder="Address 2" id="address2" /><br>
